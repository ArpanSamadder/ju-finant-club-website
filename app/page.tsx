...
export default function HomePage() {
  return (
    <main className="bg-[#020817] text-white">
      <section className="relative h-[66.6667vw] min-h-[100svh] overflow-hidden bg-[#020817] max-md:h-[120svh] max-md:min-h-[100svh]">
        <img src="/images/hero/hero-bg-v2.png" alt="" className="absolute inset-0 h-full w-full object-cover object-center" />
