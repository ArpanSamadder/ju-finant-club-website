...
export default async function HomePage() {
  ...
  return (
    <div className="bg-[#020817] text-white">
      <div className="home-hero-reveal-root">
        <section id="home-hero-section" className="home-hero-state relative min-h-[calc(100svh-72px)] overflow-hidden bg-[#020817]">
          <img
        ...
        <section id="legacy-foundation" className="home-legacy-state relative min-h-[calc(100svh-72px)] overflow-hidden bg-[#020817] px-6 py-[7vw]">
