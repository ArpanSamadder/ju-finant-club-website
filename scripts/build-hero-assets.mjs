...
if (mobileMetadata.width !== 941 || mobileMetadata.height !== 1672) {
  throw new Error(
    `mobile hero source must be 941x1672; received ${mobileMetadata.width ?? 'unknown'}x${mobileMetadata.height ?? 'unknown'}.`
  );
}
...
console.log(
  `[hero-assets] mobile: 941x1672; AVIF ${mobileAvifStats.size} bytes; WebP ${mobileWebpStats.size} bytes`
);
